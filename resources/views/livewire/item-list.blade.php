<div>
    ...
    <div class="flex flex-col gap-4 mb-6 md:flex-row">
        {{-- Select Type --}}
        <select wire:model.live="type" class="w-full select select-bordered md:w-42">
        ...
        {{-- Select Category --}}
        <select wire:model.live="category" class="w-full select select-bordered md:w-42"
        ...
        {{-- Select Subcategory --}}
        <select wire:model.live="subcategory" class="w-full select select-bordered md:w-42"
        ...
        {{-- Select Tier --}}
        <select wire:model.live="tier" class="w-full select select-bordered md:w-42">
    ...
    <!-- Daftar Item -->
    @if (!empty($items))
        <div class="grid grid-cols-1 gap-4 mt-6 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
